...
class RawZefyrButton extends StatefulWidget {
  ...
  @override
  _RawZefyrButtonState createState() => _RawZefyrButtonState();
}

class _RawZefyrButtonState extends State<RawZefyrButton> {
  @override
  Widget build(BuildContext context) {
